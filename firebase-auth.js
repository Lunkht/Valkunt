...
const firebaseConfig = {
  ...
  authDomain: "valkunt-9f0ec.firebaseapp.com",
projectId: "valkunt-9f0ec",
storageBucket: "valkunt-9f0ec.firebasestorage.app",
...
onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
        ...
        // User is signed out
        if (projectName) {
            projectName.textContent = 'Valkunt Projects';
        }
        if (userAvatar) {
